...
def main(args):
    ...
    w = join_files.joinFiles(args.infiles, args.incfile, args.outfile)
    
    logging.info('join the input files')
    w.join()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
        Example:
            join_files.py -ii ~/indir/V1_HILIC_POS_0-6min_Original.xlsx ~/indir/V1_HILIC_POS_4-11min_Original.xlsx -ic ~/indir/Classification_V1.xlsx -o ~/outdir/V1_HILIC_POS_combined-filtered.xlsx
        ''')
